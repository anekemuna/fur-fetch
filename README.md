# Web Development Project 4 - *Fur Fetch*
...
- Making the page web responsize and styling. 
- I struggled with ESLint errors when using useEffect to mount the inital dog.
- Figuring out when to add a dog to the history list.
